...
public class EstateCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("estate")
            ...
            // /estate addmoney <amount> - Admin command to add money
            // Note: For full permission checking, use Fabric Permissions API or LuckPerms
            .then(Commands.literal("addmoney")
                .requires(source -> source.getServer() != null) // Server-side only, TODO: add proper permission check
            ...
            // /estate setmoney <amount> - Admin command to set money
            .then(Commands.literal("setmoney")
                .requires(source -> source.getServer() != null) // Server-side only
